...
namespace Pagination.Controllers
{
    public class ProductController : Controller
    {
        ...
        decimal pageSize = 0; // maximum of products displayed per page
        decimal page = 0;
        decimal skipSize = 0;
        ...
        public IActionResult Index(decimal? pageNumber, int productsPerPage)
        {
            ...
            numberOfPages = Math.Ceiling(numberOfProducts / pageSize);
        ...
        /// <summary>
        /// Get the value of the selectlist: how many products should be displayed per page
        /// </summary>
